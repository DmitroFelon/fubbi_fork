...
<div class="">
    ...
    <div class="tab-content clearfix">
        <div class="tab tab-pane" id="plan-wrapper">
            <?php echo $__env->make('pages.client.projects.tabs.plan', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
        <div class="tab tab-pane active" id="quiz-wrapper">
            <?php echo $__env->make('pages.client.projects.tabs.quiz', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
        <div class="tab tab-pane" id="keywords-wrapper">
            <?php echo $__env->make('pages.client.projects.tabs.keywords', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
    </div>
</div>

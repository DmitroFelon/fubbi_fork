<fieldset>
    ...
    <?php echo Form::bsText('themes', null, __("Type content themes here"), __("Type at least 10 themes. Separate by coma or click 'enter'."), [ 'data-role'=>"tagsinput"]); ?>


    <div class="form-group <?php if (! ( isset($project) and $project->themes_order != '' )): ?> hide <?php endif; ?>"
         id="themes-order-list-wrapper">
        <?php echo Form::label('', __("Please list top 5 content themes in order of priority.")); ?>
    ...
    <?php echo Form::bsText('questions', null, __('What are the top 3 questions clients desperately want answers to?'), __("Separate by coma or click 'enter'"), ['required', 'data-role'=>"tagsinput"]); ?>
    ...
    <?php echo Form::bsText('article_images_links', null, __("You can do that by sharing examples to 5 articles with images that you like – just type in the URL."), __('Separate by coma or click "enter".'), ['required', 'data-role'=>"tagsinput"]); ?>

    <?php echo Form::bsText('avoid_keywords', null, __('Do you have keywords that you want us to avoid or content that you would not want us to use? Separate by coma or click "enter".'), '', [ 'data-role'=>'tagsinput']); ?>

    <?php echo Form::bsText('image_pages', null, __("You can also send us URLs of web pages that have the kind of images you like. Just type the urls below."), '', [ 'data-role'=>'tagsinput']); ?>

    <?php echo Form::bsText('google_access', null, __("We use Google docs to have you approve your articles. Please add all the email addresses of people in your organisation that need access."), '', [ 'data-role'=>"tagsinput"]); ?>
